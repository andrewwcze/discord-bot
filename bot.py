...
class Commands(commands.Cog):
    ...
    @commands.command(name="elist")
    async def _embed(self, ctx):
        """Embedded version of servers that bot is in."""
    ...
    async def _write(self, ctx: commands.Context):
    ...
    async def _clear(self, ctx, number):
        ...
        if int(number) > 1000:
            await ctx.send("Try smaller number :)")
            time.sleep(3)
    ...
    async def audio_player_task(self):
        while True:
            ...
            if not self.loop:
                ...
                # reasons.
                try:
                    async with time.sleep(180):  # 3 minutes
...
class Music(commands.Cog):
    ...
    async def _join(self, ctx: commands.Context):
        """Připojí se do hlasového kanálu."""
    ...
    async def _summon(self, ctx: commands.Context, *, channel: discord.VoiceChannel = None):
        """Franta se připojí k tobě do kanálu.
    ...
    async def _leave(self, ctx: commands.Context):
        """Odstraní frontu a opustí hlasový kanál."""
    ...
    async def _volume(self, ctx: commands.Context, *, volume: int):
        """Nastaví hlasitost hudby. Změna se projeví až při další písničce"""
    ...
    async def _now(self, ctx: commands.Context):
        """Zobrazí momentálně přehrávanou songu."""
    ...
    async def _pause(self, ctx: commands.Context):
        """Pozastaví momentálně přehrávaný song."""
    ...
    async def _resume(self, ctx: commands.Context):
        """Spustí dříve pozastavenou songu."""
    ...
    async def _stop(self, ctx: commands.Context):
        """zastaví spuštěnou songu a vyčistí frontu."""
    ...
    async def _remove(self, ctx: commands.Context, index: int):
        """Odstraní songu podle daného indexu."""
    ...
    async def _loop(self, ctx: commands.Context):
        """Bude opakovat momentálně hranou songu.
